...
<body>
    ...
    <input type="file" id="pimage" name="pimage" accept="image/*" required><br><br>

    <label for="cimage">Cover Image:</label>
    <input type="file" id="cimage" name="cimage" accept="image/*"><br><br>
